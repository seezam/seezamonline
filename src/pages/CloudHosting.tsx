...
export default function CloudHosting({ locale }: CloudHostingProps) {
  const text = translations[locale].cloudHosting;
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none z-0" aria-hidden="true">
        <div className="absolute -top-40 -left-40 w-96 h-96 bg-gradient-to-br from-sky-500/20 to-cyan-500/20 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-gradient-to-br from-cyan-500/20 to-sky-500/20 rounded-full blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-gradient-to-r from-sky-500/5 to-cyan-500/5 rounded-full blur-3xl" />
      </div>
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            <div className="flex justify-center mb-8">
              <div className="p-6 bg-gradient-to-br from-sky-500/10 to-cyan-500/10 rounded-2xl backdrop-blur-sm border border-sky-500/20">
            ...
            <h1 className="text-4xl md:text-5xl font-sans font-bold text-center leading-tight mb-5">
              <span className="bg-gradient-to-r from-sky-400 to-cyan-500 bg-clip-text text-transparent">{text.title}</span>
            </h1>
            ...
            {features.map((feature, i) => (
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div className="p-3 bg-gradient-to-br from-sky-500/10 to-cyan-500/10 rounded-xl backdrop-blur-sm border border-sky-500/20">
