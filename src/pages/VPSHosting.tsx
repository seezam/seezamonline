...
export default function VPSHosting({ locale }: VPSHostingProps) {
  const text = translations[locale].vpsHosting;
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-sans font-bold text-center leading-tight mb-5">
              <span className="bg-gradient-to-r from-orange-400 to-red-500 bg-clip-text text-transparent">{text.title}</span>
            </h1>
